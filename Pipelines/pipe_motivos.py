...
url = 'https://drive.google.com/u/0/uc?id=1C1HxKvoRtlmuUi-iYbDaDJiYvWgypniZ&export=download'
...
with beam.Pipeline(options=options) as p:
    ...
    pcoll | 'Write to GCS' >> beam.io.WriteToText('gs://data-lake-pf/data-lake/motivos.csv')