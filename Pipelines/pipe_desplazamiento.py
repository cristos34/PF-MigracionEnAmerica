...
url = 'https://drive.google.com/u/0/uc?id=1e47GrA_E-8SejstVOFmpnTJLNAyx38XH&export=download'
...
with beam.Pipeline(options=options) as p:
    ...
    pcoll | 'Write to GCS' >> beam.io.WriteToText('gs://data-lake-pf/data-lake/desplazamiento.csv')