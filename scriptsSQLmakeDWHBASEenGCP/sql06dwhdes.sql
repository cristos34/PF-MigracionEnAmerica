...
# scriptsql : sql06dwhdes
#----------------------------------------------------------------------------
#
create table `poetic-bison-386122.DWHmigraciones.dwhdesplazamiento` AS (
SELECT 
type_tabla,
coddesplazamiento,
codpais, 
...
porconflictoraw,
porconflictointerno,
porconflictointernoraw,
pordesastreinterno,
pordesastreinternoraw,
pordesastre
FROM `poetic-bison-386122.trfmigraciones.trfdesplazamientos`
);