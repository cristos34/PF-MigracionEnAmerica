...
# scriptsql : sqltrfmigracionneta
#----------------------------------------------------------------------------
#
create table `poetic-bison-386122.trfmigraciones.trfmigracionneta` AS (
SELECT
"MGN" AS type_tabla,
...
FROM `poetic-bison-386122.rawmigraciones.rawmigracionneta`
);
